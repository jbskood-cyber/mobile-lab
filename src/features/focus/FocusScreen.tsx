...
const styles = StyleSheet.create({
  ...
  contextTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 13, lineHeight: 17 },
  contextMeta: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 2 },
  timerWrap: { alignItems: 'center', marginTop: 18 },
  timerCopy: { alignItems: 'center' },
  phase: { fontFamily: 'InstrumentSans_500Medium', fontSize: 11, lineHeight: 14 },
  timer: { fontFamily: 'InstrumentSans_400Regular', fontSize: 48, lineHeight: 58, letterSpacing: -1.8, fontVariant: ['tabular-nums'], marginTop: 3 },
  cycle: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 2 },
  ...
  messageText: { fontFamily: 'InstrumentSans_500Medium', fontSize: 10.5, lineHeight: 14, textAlign: 'center' },
  ...
  summaryItem: { flex: 1 },
  summaryValue: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 15, lineHeight: 19, fontVariant: ['tabular-nums'] },
  summaryLabel: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9, lineHeight: 12, marginTop: 2 },
  ...
  projectChoiceText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11, lineHeight: 14 },
  ...
  optionTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 12.5, lineHeight: 16 },
  optionMeta: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 1 },
  empty: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10.5, lineHeight: 15, paddingVertical: 16 },
  fieldGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  field: { width: '48%' },
  fieldLabel: { fontFamily: 'InstrumentSans_700Bold', fontSize: 8.5, lineHeight: 12, letterSpacing: 0.6, marginBottom: 4 },
  numberInput: { minHeight: 44, borderRadius: 11, borderWidth: StyleSheet.hairlineWidth, paddingHorizontal: 11, fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14, lineHeight: 18, fontVariant: ['tabular-nums'], marginBottom: 8 },
  toggleRow: { minHeight: 50, flexDirection: 'row', alignItems: 'center' },
  toggleLabel: { flex: 1, fontFamily: 'InstrumentSans_500Medium', fontSize: 12, lineHeight: 16, paddingRight: 10 },
});
