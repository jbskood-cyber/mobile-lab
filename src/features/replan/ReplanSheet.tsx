...
const styles = StyleSheet.create({
  ...
  meta: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10.5, lineHeight: 14, marginTop: 3 },
  ...
  actionText: { fontFamily: 'InstrumentSans_500Medium', fontSize: 9.5, lineHeight: 12 },
