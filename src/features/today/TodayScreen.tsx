...
const styles = StyleSheet.create({
  ...
  warningText: { fontFamily: 'InstrumentSans_500Medium', fontSize: 10.5, lineHeight: 14 },
  ...
  captureInput: { flex: 1, fontFamily: 'InstrumentSans_400Regular', fontSize: 13.5, lineHeight: 18, paddingVertical: 10 },
  ...
  capacityCopy: { flex: 1 },
  capacityTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 13.5, lineHeight: 18 },
  capacityMeta: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10, lineHeight: 14, marginTop: 2 },
  ...
  replanTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 12.5, lineHeight: 16 },
  replanCopy: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 2 },
  impulseLink: { minHeight: 36, justifyContent: 'center', paddingHorizontal: 4 },
  impulseText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11, lineHeight: 14 },
