...
const styles = StyleSheet.create({
  safe: { flex: 1 }, header: { height: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 4 }, iconButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center' }, headerTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14, lineHeight: 18 }, content: { paddingHorizontal: 14, paddingBottom: 48 },
  titleRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, paddingVertical: 12 }, bigCheck: { width: 25, height: 25, marginTop: 2, borderRadius: 13, borderWidth: 1.5, alignItems: 'center', justifyContent: 'center' }, title: { flex: 1, fontFamily: 'InstrumentSans_700Bold', fontSize: 23, lineHeight: 29, letterSpacing: -0.55 }, titleDone: { textDecorationLine: 'line-through' }, pressed: { opacity: 0.68 },
  metaGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 5, paddingBottom: 10 }, meta: { minHeight: 32, maxWidth: '100%', borderRadius: 10, flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 9 }, metaText: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, flexShrink: 1 },
  firstStep: { minHeight: 60, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, padding: 11, marginVertical: 5 }, firstLabel: { fontFamily: 'InstrumentSans_700Bold', fontSize: 8.5, lineHeight: 12, letterSpacing: 1 }, firstText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 13, lineHeight: 18, marginTop: 3 },
  actionRow: { flexDirection: 'row', gap: 6, paddingVertical: 8, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth }, action: { flex: 1, minHeight: 46, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, alignItems: 'center', justifyContent: 'center', gap: 2 }, actionText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 10, lineHeight: 13 },
  section: { paddingTop: 16 }, sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 5 }, sectionTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 15, lineHeight: 19 }, sectionDetail: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10.5, lineHeight: 14 }, subtask: { minHeight: 46, flexDirection: 'row', alignItems: 'center', gap: 9, borderBottomWidth: StyleSheet.hairlineWidth }, smallCheck: { width: 20, height: 20, borderRadius: 10, borderWidth: 1.2, alignItems: 'center', justifyContent: 'center' }, subtaskText: { flex: 1, fontFamily: 'InstrumentSans_400Regular', fontSize: 13, lineHeight: 18 }, notes: { fontFamily: 'InstrumentSans_400Regular', fontSize: 13, lineHeight: 19 },
  sessionRow: { minHeight: 49, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: StyleSheet.hairlineWidth }, sessionDate: { fontFamily: 'InstrumentSans_500Medium', fontSize: 12, lineHeight: 16 }, sessionMode: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 1 }, sessionDuration: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5, lineHeight: 15, fontVariant: ['tabular-nums'] }, emptyCopy: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10.5, lineHeight: 15, paddingVertical: 14 },
  deleteButton: { minHeight: 48, marginTop: 22, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 }, deleteText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 12, lineHeight: 16 }, missing: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 }, missingTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 18, lineHeight: 23 }, primary: { minHeight: 48, marginTop: 16, borderRadius: 12, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center' }, primaryText: { fontFamily: 'InstrumentSans_700Bold', fontSize: 12.5, lineHeight: 16 },
});
