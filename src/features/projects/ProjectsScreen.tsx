...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontFamily: 'InstrumentSans_400Regular', fontSize: 13.5, lineHeight: 18, paddingHorizontal: 9, paddingVertical: 10 },
  ...
  filterText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5, lineHeight: 15 },
  filterCount: { fontFamily: 'InstrumentSans_500Medium', fontSize: 10, lineHeight: 13, fontVariant: ['tabular-nums'] },
  ...
  name: { flex: 1, fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14, lineHeight: 18 },
  progress: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 10.5, lineHeight: 14, fontVariant: ['tabular-nums'] },
  meta: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 3 },
  ...
  emptyTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14, lineHeight: 18, marginTop: 9 },
  emptyCopy: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10.5, lineHeight: 14, marginTop: 3 },
});