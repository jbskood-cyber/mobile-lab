...
const styles = StyleSheet.create({
  ...
  projectHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, paddingTop: 7, paddingBottom: 12 }, projectIcon: { width: 44, height: 44, borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, projectCopy: { flex: 1, minWidth: 0 }, title: { fontFamily: 'InstrumentSans_700Bold', fontSize: 24, lineHeight: 29, letterSpacing: -0.6 }, description: { fontFamily: 'InstrumentSans_400Regular', fontSize: 11.5, lineHeight: 16, marginTop: 3 },
  metrics: { flexDirection: 'row', borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, paddingVertical: 11 }, metric: { flex: 1 }, metricValue: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 16, lineHeight: 20, fontVariant: ['tabular-nums'] }, metricLabel: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9, lineHeight: 12, marginTop: 2 },
  actions: { flexDirection: 'row', gap: 6, paddingVertical: 9 }, action: { flex: 1, minHeight: 46, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, alignItems: 'center', justifyContent: 'center', gap: 2 }, actionText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 10, lineHeight: 13 },
  sectionHeader: { minHeight: 37, marginTop: 8, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, sectionTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14.5, lineHeight: 19 }, sectionDetail: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10, lineHeight: 13 }, list: { borderTopWidth: StyleSheet.hairlineWidth },
  completedHeader: { minHeight: 52, marginTop: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: StyleSheet.hairlineWidth }, sessionList: { borderTopWidth: StyleSheet.hairlineWidth }, sessionRow: { minHeight: 51, flexDirection: 'row', alignItems: 'center', borderBottomWidth: StyleSheet.hairlineWidth }, sessionCopy: { flex: 1, minWidth: 0 }, sessionTitle: { fontFamily: 'InstrumentSans_500Medium', fontSize: 12, lineHeight: 16 }, sessionDate: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 13, marginTop: 2 }, sessionValue: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5, lineHeight: 15, fontVariant: ['tabular-nums'] }, empty: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10.5, lineHeight: 15, paddingVertical: 17, textAlign: 'center' },
  missing: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 }, missingTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 18, lineHeight: 23 }, primary: { minHeight: 48, marginTop: 16, borderRadius: 12, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'center' }, primaryText: { fontFamily: 'InstrumentSans_700Bold', fontSize: 12.5, lineHeight: 16 },
});
