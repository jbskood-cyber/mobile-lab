...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, fontFamily: 'InstrumentSans_400Regular', fontSize: 13.5, lineHeight: 18, paddingHorizontal: 9, paddingVertical: 10 },
  add: { width: 36, height: 36, marginRight: 5, borderRadius: 18, alignItems: 'center', justifyContent: 'center' },
  disabled: { opacity: 0.3 },
  count: { fontFamily: 'InstrumentSans_500Medium', fontSize: 10.5, lineHeight: 14, marginTop: 10, marginBottom: 2 },
