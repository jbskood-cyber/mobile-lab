...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14, lineHeight: 18 },
  content: { flex: 1, paddingHorizontal: 20, paddingTop: 30, alignItems: 'center' },
  eyebrow: { fontFamily: 'InstrumentSans_700Bold', fontSize: 10, lineHeight: 14, letterSpacing: 1.7 },
  title: { maxWidth: 420, fontFamily: 'InstrumentSans_700Bold', fontSize: 28, lineHeight: 34, letterSpacing: -0.7, textAlign: 'center', marginTop: 10 },
  context: { fontFamily: 'InstrumentSans_400Regular', fontSize: 11.5, lineHeight: 16, marginTop: 7 },
  ...
  firstLabel: { fontFamily: 'InstrumentSans_500Medium', fontSize: 10, lineHeight: 14, textTransform: 'uppercase', letterSpacing: 0.8 },
  firstText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 15, lineHeight: 21, marginTop: 5 },
  timer: { fontFamily: 'InstrumentSans_400Regular', fontSize: 62, lineHeight: 72, letterSpacing: -2.3, fontVariant: ['tabular-nums'], marginTop: 32 },
  timerMeta: { maxWidth: 310, fontFamily: 'InstrumentSans_400Regular', fontSize: 11.5, lineHeight: 17, textAlign: 'center', marginTop: 3 },
  ...
  starterValue: { fontFamily: 'InstrumentSans_700Bold', fontSize: 17, lineHeight: 20, fontVariant: ['tabular-nums'] },
  starterLabel: { fontFamily: 'InstrumentSans_400Regular', fontSize: 9.5, lineHeight: 12 },
  ...
  primaryText: { fontFamily: 'InstrumentSans_700Bold', fontSize: 13.5, lineHeight: 18 },
  message: { fontFamily: 'InstrumentSans_500Medium', fontSize: 10.5, lineHeight: 15, marginTop: 12, textAlign: 'center' },
  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingBottom: 80 },
  emptyTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 18, lineHeight: 23, marginTop: 12 },
  emptyCopy: { maxWidth: 280, fontFamily: 'InstrumentSans_400Regular', fontSize: 12, lineHeight: 17, textAlign: 'center', marginTop: 5 },
});
