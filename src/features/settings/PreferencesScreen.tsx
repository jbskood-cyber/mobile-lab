...
const styles = StyleSheet.create({
  ...
  display: { fontFamily: 'InstrumentSans_700Bold', fontSize: 26, lineHeight: 31, letterSpacing: -0.65, marginTop: 6 },
  intro: { fontFamily: 'InstrumentSans_400Regular', fontSize: 12, lineHeight: 17, marginTop: 3 },
  section: { marginTop: 20 },
  sectionTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14.5, lineHeight: 19, marginBottom: 7 },
  ...
  appearanceLabel: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5, lineHeight: 15 },
  appearanceDetail: { fontFamily: 'InstrumentSans_400Regular', fontSize: 8.8, lineHeight: 12, textAlign: 'center', marginTop: 2 },
  ...
  numberLabel: { flex: 1, fontFamily: 'InstrumentSans_500Medium', fontSize: 12.5, lineHeight: 16 },
  ...
  numberSymbol: { fontFamily: 'InstrumentSans_500Medium', fontSize: 18, lineHeight: 21 },
  numberValue: { minWidth: 54, textAlign: 'center', fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5, lineHeight: 15, fontVariant: ['tabular-nums'] },
  ...
  actionTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 12.5, lineHeight: 16 },
  actionDetail: { fontFamily: 'InstrumentSans_400Regular', fontSize: 10, lineHeight: 13, marginTop: 2 },
  ...
  diagnosticValue: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 13, lineHeight: 17, fontVariant: ['tabular-nums'] },
  diagnosticLabel: { fontFamily: 'InstrumentSans_400Regular', fontSize: 8.8, lineHeight: 12, marginTop: 2 },
  ...
  importError: { fontFamily: 'InstrumentSans_500Medium', fontSize: 11, lineHeight: 15, marginTop: 8 },
});
