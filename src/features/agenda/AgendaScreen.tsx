...
const styles = StyleSheet.create({
  ...
  segmentText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5, lineHeight: 15 },
  ...
  routineCount: { position: 'absolute', right: 5, top: 4, fontFamily: 'InstrumentSans_600SemiBold', fontSize: 8.5, lineHeight: 11 },
  ...
  todayText: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 11.5 },
  ...
  smartText: { fontFamily: 'InstrumentSans_500Medium', fontSize: 11.5, lineHeight: 15 },
  ...
  emptyTitle: { fontFamily: 'InstrumentSans_600SemiBold', fontSize: 14, lineHeight: 18, marginTop: 8 },
